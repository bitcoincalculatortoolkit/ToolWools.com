...
export const blogPosts: BlogPost[] = [
  {
    ...
    seoTitle: 'How to Compress Images for Web Without Losing Quality | ToolWools Blog',
    seoDescription:
  ...
  },
  {
    ...
    title: '10 Best Free SEO Tools in 2026 (No Signup Required)',
    excerpt:
    ...
    seoTitle: '10 Best Free SEO Tools in 2026 (No Signup Required) | ToolWools Blog',
    seoDescription:
      'Discover the 10 best free SEO tools in 2026 that require no signup. Domain authority checkers, meta tag generators, keyword tools and more — all completely free.',
  ...
  },
  {
    ...
    seoTitle: 'The Complete Guide to JSON Formatting & Validation | ToolWools Blog',
    seoDescription:
  ...
  },
  {
    ...
    seoTitle: 'How to Reduce PDF File Size: 5 Methods That Actually Work | ToolWools Blog',
    seoDescription:
