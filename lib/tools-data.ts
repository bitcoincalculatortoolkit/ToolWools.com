...
const toolsRegistry: ToolData[] = [
  ...
  },
  {
    ...
    category: 'pdf-tools',
    categoryLabel: 'PDF Tools',
    description: 'Remove password protection from a PDF. Enter the current password and download an unlocked copy.',
    longDescription:
      'ToolWools\' free Unlock PDF tool removes password protection from any PDF you own. Enter the current password and download a password-free copy instantly. Everything runs locally in your browser — your files and passwords never leave your device.',
    heroSubheadline:
      'Remove password protection from any PDF you own. Enter the password, download an unlocked copy. Free, private, instant — files processed entirely in your browser, nothing uploaded.',
    heroHighlights: ['Remove any password', 'No file upload', '100% private'],
    seoTitle: 'Free Unlock PDF — Remove PDF Password Online | ToolWools',
    seoDescription:
      'Remove password protection from PDF files for free. Enter the current password and download an unlocked copy instantly. No signup, no upload, works in your browser.',
    tags: ['unlock pdf', 'remove pdf password', 'pdf password remover', 'decrypt pdf', 'unprotect pdf'],
    relatedTools: ['watermark-pdf', 'sign-pdf', 'merge-pdf'],
    howToSteps: [
      { name: 'Upload your protected PDF', text: 'Drag and drop a password-protected PDF onto the upload zone or click to browse. The file is loaded locally — never uploaded to any server.' },
      { name: 'Enter the current password', text: 'Type the password required to open the PDF. This must be the correct password — the tool cannot crack or guess unknown passwords.' },
      { name: 'Remove and download', text: 'Click "Remove Password & Download". The tool loads the PDF using your password, saves a new copy without any encryption, and downloads it to your device.' },
      { name: 'Open the unlocked PDF', text: 'The downloaded PDF opens without any password in Adobe Acrobat, Preview, Chrome, or any modern PDF viewer.' },
    ],
    faqs: [
      { q: 'Can this tool remove any PDF password?', a: 'It can remove passwords from PDFs where you already know the password. Enter the password and the tool saves a new copy without encryption. It cannot crack or guess unknown passwords.' },
      { q: 'Are my files and passwords uploaded to a server?', a: 'No. Everything runs locally in your browser using pdf-lib (open source). Your files and passwords never leave your device. You can verify by disconnecting your internet after the page loads — the tool still works.' },
      { q: 'What is the difference between a user password and an owner password?', a: 'A user password is required to open the PDF. An owner password controls permissions (printing, copying, editing). If the PDF requires a password to open, that is the user password. If it opens but restricts actions, the owner password is separate.' },
      { q: 'Will the unlocked PDF look exactly the same?', a: 'Yes. Removing the password does not change the content, layout, fonts, images, or any other part of the document. Only the encryption layer is removed.' },
      { q: 'Can I add a password to a PDF in the browser?', a: 'Browser security restrictions prevent client-side AES encryption with standard JavaScript libraries. For adding password protection, we recommend Adobe Acrobat Online or your operating system\'s built-in PDF tools (macOS Preview, Windows Print to PDF).' },
    ],
  },
];
